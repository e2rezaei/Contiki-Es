...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-25-nodes/udp-server.c</source>
      <commands EXPORT="discard">make udp-server.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-25-nodes/udp-server.sky</firmware>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/rpl-udp-25-nodes/udp-client.c</source>
      <commands EXPORT="discard">make udp-client.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/rpl-udp-25-nodes/udp-client.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.RimeAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.IPAddress</moteinterface>
      <moteinterface>se.sics.cooja.interfaces.Mote2MoteRelations</moteinterface>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.0068935421995976135 0.0 0.0 0.0068935421995976135 176.77294948847157 186.6010705029617</viewport>
    </plugin_config>
    <width>633</width>
    <z>3</z>
    <height>654</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <script>//ReadMe: It is completely similar to loglistener output. :)&#xD;
&#xD;
...
&#xD;
&#xD;
//ReadMe: It is completely similar to loglistener output. :)&#xD;
&#xD;
&#xD;
TIMEOUT(3601000);&#xD;
&#xD;
